...
type Event struct {
	...
	CreatorID    uuid.UUID         `sql:"type:uuid" json:"creator_id"`
...
type EventParticipant struct {
	ID        uuid.UUID     `sql:"type:uuid;primary key" json:"id"`
	MemberID  uuid.UUID     `sql:"type:uuid" json:"member_id"`
	EventID   uuid.UUID     `sql:"type:uuid" json:"event_id"`
...
func (p *EventParticipants) DeleteEventParticipants(db *sql.DB, eventID uuid.UUID) error {
	query := `UPDATE events_participants SET deleted_at = $1 WHERE event_id = $2`
