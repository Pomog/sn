...
func handleFollower(ctx *socialnetwork.Context) {
...
func createNotif(notif *models.Notification, ctx *socialnetwork.Context) {
...
func handleGetAllFollowersRequest(ctx *socialnetwork.Context) {
...
func handleGetAllFolloweesRequest(ctx *socialnetwork.Context) {
...
// FollowerRoute FollowerHandler defines the structure for handling follower requests.
